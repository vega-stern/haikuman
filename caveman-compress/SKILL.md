...
description: >
  ...
  Trigger: /haikuman:compress <filepath> (or /caveman:compress) or "compress memory file"
---
...
`/haikuman:compress <filepath>` (or `/caveman:compress <filepath>`) or when user asks to compress a memory file.
